<aside id="sidebar" class="sidebar" role="navigation" aria-label="Navegación principal">
    <div class="sidebar-header">
        <img src="<?php echo media('image/ovisoft.png'); ?>" alt="Logo" class="sidebar-logo sidebar-logo-full">
        <img src="<?php echo media('image/icon.svg'); ?>" alt="Ovisoft" class="sidebar-logo sidebar-logo-icon">
    </div>
    ...
    <nav class="sidebar-nav">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a href="#" class="nav-link" data-bs-toggle="collapse" data-bs-target="#menuStyleSubmenu">
                    <i class="fas fa-bars"></i>
                    <span class="nav-text">Menu Style</span>
                    <i class="fas fa-chevron-right ms-auto submenu-arrow"></i>
                </a>
                <div class="collapse" id="menuStyleSubmenu">
                    <ul class="submenu">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="menuAdminPages">
                    <ul class="submenu">
                        <li><a href="login.html"><i class="fas fa-sort-amount-up-alt me-2"></i>Login Page</a></li>
                        <li><a href="register.html"><i class="fas fa-sort-amount-up-alt me-2"></i>Register Page</a>
                        </li>
                        <li><a href="lock_screen.html"><i class="fas fa-sort-amount-up-alt me-2"></i>Lock Screen</a>
                        </li>
                    </ul>
                </div>
            </li>
